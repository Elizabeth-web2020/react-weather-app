...
function SummaryCard({day}) {
  ...
  return (
    <li className="container p-1 flex items-center justify-center bg-gray-200 rounded-lg my-auto mr-1">
      <div className="my-auto">
        <p className="font-bold text-3xl text-ping-600 mb-1">{Math.round(day.main.temp)}&deg;C</p>
        <p className="text-xl text-gray-800 tracking-widest">
          {day.weather[0].main}
